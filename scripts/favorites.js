let washroomCardGroup = document.getElementById("washroomCardGroup");
//----------------------------------------------------------
        ...
        .then(userDoc => {
            ...
            bookmarks.forEach(thisWashroomID => {
                ...
                db.collection("washrooms").doc(thisWashroomID).get().then(doc => {
                    ...
                    var washroomAddress = doc.data().address; //get unique ID to each washroom to be used for fetching right image
